...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <h1>Hi - This is Thursday's change</h1>
    <p>..This is the new view change.. Mikes new fantastic ggggfffgggchangeThis is a sample Java application deployed to Heroku. It's a reasonably simple app - but a good foundation for understanding how to get the most out of the Heroku platform.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <ul>
        <li>Hi This app was deployed to Heroku, either using Git or by using <a href="https://github.com/heroku/java-getting-started">Heroku Button</a> on the repository.</li>
